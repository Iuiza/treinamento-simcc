...
def salvar_nova_producao(producao:Producao) -> str:
    ...
    try:
        ...
        with conexao.cursor() as cursor:
            cursor.execute(sql, (producao.nomeartigo, producao.anoartigo, producao.pesquisadores_id,producao.issn))
...
def atualizar_por_id(producao:Producao) -> str:
    ...
    try:
        # Utiliza a conexão para abrir um cursor e executar o SQL
        with conexao.cursor() as cursor:
            cursor.execute(sql, ( producao.nomeartigo, producao.issn,producao.anoartigo,producao.producoes_id))
