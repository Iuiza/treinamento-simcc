...
>
> O endpoint de apagar só funciona usando o lattes_id de um pesquisador adicionar. Com o lattes_id dos pesquisadores previamente cadastrados não está funcionando.
